...
Para viabilizar o objetivo geral, estabelecem-se os seguintes objetivos específicos, conforme sugestão do Prof. Reginaldo:

\begin{itemize}
  \item O ambiente e os processos PBL contém cenários capazes de produzir eventos para avaliação de engajamento de alunos em auto-estudos?
  \item Idem para atividades de projetos por grupos de alunos, relacionados aos artefatos?
\end{itemize}
