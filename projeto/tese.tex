...
\begin{figure}[H]
  \centering
  \includegraphics[height=0.85\textheight, keepaspectratio]{plantuml/afonsystem_class}
  \caption{Diagrama de Classes do Sistema de Coleta}
  \label{fig:afonsystem_class}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{plantuml/afonsystem_sequence}
  \caption{Diagrama de Sequência - Criação de Snapshot no Sistema de Coleta}
  \label{fig:afonsystem_sequence}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{plantuml/afonsystem_components}
  \caption{Diagrama de Componentes do Sistema de Coleta}
  \label{fig:afonsystem_components}
\end{figure}
