...
À luz do problema delineado, o objetivo geral desta tese é projetar e especificar uma arquitetura de captura, integração e organização de eventos de ensino e aprendizagem que integre as visões arquiteturais estrutural, comportamental e de processo, de forma a alimentar um gêmeo digital do ecossistema PBL e subsidiar a tomada de decisão do corpo docente, e demonstrar sua viabilidade por meio da implementação de um protótipo e de um exemplo aplicado em disciplina PBL, com avaliação arquitetural (ATAM/SEI) e operacional (cobertura e completude, latência/\textit{throughput}, integridade e confiabilidade).
...
\begin{itemize}
  \item Delimitar escopo, stakeholders e critérios de sucesso; levantar e formalizar requisitos funcionais/não funcionais, riscos e salvaguardas éticas (privacidade, consentimento e minimização de dados).
  \item Propor o modelo conceitual do gêmeo digital integrando as visões
        ...
        entre fontes, eventos e entidades do domínio.
  \item Definir e padronizar eventos, metadados e contratos de dados por visão
        (tipos, fontes, método de coleta, periodicidade, agregação e validação),
        destacando limites de interpretação e vieses potenciais.
  ...
  \item Implementar um protótipo funcional integrado ao ecossistema de projeto
        ...
        painéis alinhados a perfis de uso (docente, coordenação).
  \item Planejar e conduzir um \textit{exemplo aplicado} em disciplina PBL,
        com protocolo explícito (amostra, instrumentos, procedimentos,
        cronograma, compliance ética) e plano de coleta de eventos.
  \item Avaliar a arquitetura e o pipeline por métodos de avaliação
        arquitetural (ATAM/SEI) e por métricas operacionais (latência,
        throughput, perda de eventos, integridade e confiabilidade).
...
\subsubsection{Rastreabilidade entre Objetivos e Hipóteses}
